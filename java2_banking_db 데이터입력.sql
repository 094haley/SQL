...
insert into `CUSTOMER` (`cust_jumin`, `cust_name`, `cust_addr`, `cust_birth`, `cust_email`, `cust_phnum`, `cust_job`) values ('760121-1234567', '정우성', '서울', '1976-01-21', 'jws@naver.com', '010-1101-7601', '배우');
insert into `CUSTOMER` (`cust_jumin`, `cust_name`, `cust_addr`, `cust_birth`, `cust_email`, `cust_phnum`, `cust_job`) values ('750611-1234567', '이정재', '서울', '1975-06-11', 'ljj@naver.com', '010-1102-7506', '배우');
...
insert into `CUSTOMER` (`cust_jumin`, `cust_name`, `cust_addr`, `cust_birth`, `cust_email`, `cust_phnum`, `cust_job`) values ('721128-1234567', '유재석', '부산', '1972-11-28', 'yjs@naver.com', '010-6101-7211', '개그맨');
insert into `CUSTOMER` (`cust_jumin`, `cust_name`, `cust_addr`, `cust_birth`, `cust_email`, `cust_phnum`, `cust_job`) values ('920907-1234567', '강호동', '부산', '1992-09-07', 'gang@naver.com', '010-7103-9209', '개그맨');
...
insert into `CUSTOMER` (`cust_jumin`, `cust_name`, `cust_addr`, `cust_birth`, `cust_email`, `cust_phnum`, `cust_job`) values ('770314-1234567', '강동원', '광주', '1977-03-14', 'dong@navr.com', '010-8101-7703', '배우');
...
select `cust_name`, 
       ...
       `cust_job`
from `CUSTOMER` as a
left join `CARDS` as b on a.`cust_jumin` = b.`cust_jumin`;
