...
CREATE TABLE IF NOT EXISTS `bank_account` (
  `a_no` varchar(11) NOT NULL DEFAULT '000-00-0000',
...
-- 테이블 데이터 java2_bank.bank_account:~10 rows (대략적) 내보내기
INSERT INTO `bank_account` (`a_no`, `a_item_dist`, `a_item_name`, `a_c_no`, `a_balance`, `a_open_date`) VALUES
	('101-11-1001', 'S1', '자유저축예금', '730423-1000001', 410000, '2005-07-21'),
	...
	('101-22-1006', 'L2', '예금담보대출', '730423-1000001', 35000, '2013-12-11'),
	('101-23-1007', 'L3', '주택담보대출', '750210-1000002', 2700000, '2020-09-23');

-- 테이블 java2_bank.bank_customer 구조 내보내기
...
-- 테이블 데이터 java2_bank.bank_customer:~9 rows (대략적) 내보내기
...
-- 테이블 데이터 java2_bank.bank_transaction:~10 rows (대략적) 내보내기
...
INSERT INTO `acc_trades` (`trade_id`, `acc_id`, `acc_class`, `acc_contents`, `trade_money`, `acc_balance`, `imp_exp_date`) VALUES
	(1, '101-11-1001', '입금', '2월 정기급여', 3500000, 4160000, '2022-10-06 16:34:27'),
	(2, '101-11-1003', '출금', 'ATM 출금', 300000, 1200000, '2022-10-06 16:34:27'),
	(3, '101-11-1008', '입금', '2월 급여', 2800000, 3200000, '2022-10-06 16:34:27'),
	(4, '101-11-1006', '출금', '2월 공과금', 116200, 3120000, '2022-10-06 16:34:27'),
	(5, '101-11-1005', '출금', 'ATM 출금', 50000, 820000, '2022-10-06 16:34:27'),
	(6, '101-11-1006', '입금', '홍길동 이체', 400000, 3520000, '2022-10-06 16:34:27'),
	(7, '101-11-1007', '출금', '2월 관리비', 145000, 7620500, '2022-10-06 16:34:27'),
	(8, '101-11-1008', '입금', '홍길동 입금', 200000, 3400000, '2022-10-06 16:34:27'),
	(9, '101-11-1009', '입금', '연말정산 환급', 112000, 1763000, '2022-10-06 16:34:27'),
	(10, '101-11-1010', '출금', 'ATM 출금', 30000, 1080000, '2022-10-06 16:34:27');

-- 테이블 java2_banking_db.cards 구조 내보내기
CREATE TABLE IF NOT EXISTS `cards` (
  ...
  PRIMARY KEY (`card_id`),
  KEY `fk_CARDS_CUSTOMER1_idx` (`cust_jumin`),
...
INSERT INTO `cards` (`card_id`, `cust_jumin`, `acc_id`, `card_register_date`, `card_limit_money`, `card_approve_date`, `card_type`) VALUES
	('1011-1001-1001', '760121-1234567', '101-11-1001', '2020-01-21', 1000000, '2020-02-10', 'check'),
	('1011-1001-1002', '890530-1234567', '101-11-1002', '2020-06-11', 3000000, '2020-06-15', 'check'),
	('1011-1001-1003', '790413-1234567', '101-11-1003', '2020-05-30', 5000000, '2020-06-25', 'credit'),
	('1011-1001-1004', '660912-1234567', '101-11-1004', '2020-04-13', 1000000, '2020-05-10', 'credit'),
	('1011-1001-1005', '840615-1234567', '101-11-1005', '2020-09-12', 1500000, '2020-10-10', 'check'),
	('1011-1001-1006', '651021-1234567', '101-11-1006', '2020-07-28', 10000000, '2020-08-15', 'check'),
	('1011-1001-1007', '721128-1234567', '101-11-1007', '2020-06-15', 2000000, '2020-07-25', 'credit'),
	('1011-1001-1008', '920907-1234567', '101-11-1008', '2020-10-21', 5000000, '2020-11-15', 'credit'),
	('1011-1001-1009', '891209-1234567', '101-11-1009', '2020-11-28', 1000000, '2020-12-10', 'check'),
	('1011-1001-1010', '770314-1234567', '101-11-1010', '2020-09-07', 1000000, '2020-10-10', 'credit');

-- 테이블 java2_banking_db.customer 구조 내보내기
...
INSERT INTO `customer` (`cust_jumin`, `cust_name`, `cust_addr`, `cust_birth`, `cust_email`, `cust_phnum`, `cust_job`) VALUES
	...
	('721128-1234567', '유재석', '부산', '1972-11-28', 'yjs@naver.com', '010-6101-7211', '개그맨'),
	('750611-1234567', '이정재', '서울', '1975-06-11', 'ljj@naver.com', '010-1102-7506', '배우'),
	('760121-1234567', '정우성', '서울', '1976-01-21', 'jws@naver.com', '010-1101-7601', '배우'),
	('770314-1234567', '강동원', '광주', '1977-03-14', 'dong@navr.com', '010-8101-7703', '배우'),
	...
	('920907-1234567', '강호동', '부산', '1992-09-07', 'gang@naver.com', '010-7103-9209', '개그맨');
...
-- 테이블 데이터 java2_board.board_article:~28 rows (대략적) 내보내기
INSERT INTO `board_article` (`no`, `parent`, `comment`, `cate`, `title`, `content`, `file`, `hit`, `uid`, `regip`, `rdate`) VALUES
	(2, 0, 0, 'free', '테스트입니다', '테스트', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:19'),
	(3, 0, 0, 'free', '테스트입니다', '테스트33', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:27'),
	(4, 0, 0, 'free', '테스트입니다', '안녕', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:08'),
	(5, 0, 0, 'free', '테스트입니다', '테스트', 0, 1, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:19'),
	(6, 0, 0, 'free', '테스트입니다', '테스트33', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:27'),
	(7, 0, 0, 'free', '테스트입니다', '안녕', 0, 1, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:08'),
	(8, 0, 0, 'free', '테스트입니다', '테스트', 0, 1, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:19'),
	(9, 0, 0, 'free', '테스트입니다', '테스트33', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:27'),
	(10, 0, 0, 'free', '테스트입니다', '안녕', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:08'),
	(11, 0, 0, 'free', '테스트입니다', '테스트', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:19'),
	(12, 0, 0, 'free', '테스트입니다', '테스트33', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:27'),
	(14, 0, 0, 'free', '테스트입니다', '안녕', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:08'),
	(15, 0, 0, 'free', '테스트입니다', '테스트', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:19'),
	(16, 0, 0, 'free', '테스트입니다', '테스트33', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:27'),
	(17, 0, 0, 'free', '테스트입니다', '안녕', 0, 4, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:08'),
	(18, 0, 0, 'free', '테스트입니다', '테스트', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:19'),
	(19, 0, 0, 'free', '테스트입니다', '테스트33', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:27'),
	(21, 0, 0, 'free', '테스트입니다', '테스트', 0, 6, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:19'),
	(22, 0, 0, 'free', '테스트입니다', '테스트33', 0, 3, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:27'),
	(23, 0, 0, 'free', '테스트입니다', '안녕', 0, 12, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 15:55:08'),
	(24, 0, 1, 'free', '글 수정 테스트', '글 수정 테스트입니다!', 0, 31, 'carrot112', '0:0:0:0:0:0:0:1', '2022-11-02 15:53:32'),
	(34, 23, 0, 'free', NULL, '댓글111', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-10-31 18:20:11'),
	(37, 21, 0, 'free', NULL, 'postman으로 수정', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-11-01 15:40:35'),
	(38, 17, 0, 'free', NULL, 'ㅓㅗ어ㅗ', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-11-01 15:53:41'),
	(48, 0, 3, 'free', 'ㅌㅔㅅㅡㅌㅡ', '11111', 0, 3, 'carrot112', '0:0:0:0:0:0:0:1', '2022-11-03 15:42:12'),
	(49, 48, 0, 'free', NULL, 'ㅁㅁㅁㅁㅁㅁㅁㅁ', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-11-03 15:42:19'),
	(50, 48, 0, 'free', NULL, 'ㅇㅇㅇㅇㅇㅇㅇ', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-11-03 15:42:23'),
	(51, 48, 0, 'free', NULL, 'ekjldsjfklsjfkl', 0, 0, 'carrot112', '0:0:0:0:0:0:0:1', '2022-11-03 16:01:30');
...
-- 테이블 데이터 java2_board.board_file:~5 rows (대략적) 내보내기
INSERT INTO `board_file` (`fno`, `parent`, `newName`, `oriName`, `download`) VALUES
	(1, 11, '20221026163211_carrot112.jpg', 'flower2.jpg', 0),
	(2, 12, '20221026163308_carrot112.jpg', 'flower3.jpg', 0),
	(4, 3, '20221028163548_carrot112.png', 'bg_back.png', 1),
	(6, 42, '20221102171436_carrot112.jpg', 'desert.jpg', 0),
	(7, 44, '20221102171720_carrot112.jpg', 'desert.jpg', 0);
...
-- 테이블 데이터 java2_board.board_user:~5 rows (대략적) 내보내기
INSERT INTO `board_user` (`uid`, `pass`, `name`, `nick`, `email`, `hp`, `grade`, `zip`, `addr1`, `addr2`, `regip`, `rdate`) VALUES
	('a101', '1234', '홍길동', '길동', 'gd@gmail.com', '010-1234-1111', 2, NULL, NULL, NULL, '0:0:0:0:0:0:0:1', '2022-10-20 15:22:59'),
	('a102', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '김춘추', '춘추', 'cc@gmail.com', '010-1234-1112', 2, NULL, NULL, NULL, '0:0:0:0:0:0:0:1', '2022-10-20 15:40:21'),
	('a103', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '장보고', '보고', 'bogo@gmail.com', '', 2, NULL, NULL, NULL, '0:0:0:0:0:0:0:1', '2022-10-20 15:50:12'),
	('carrot112', 'c814573c7ceab9bd38ef526538d5c5066bcf8b7e0380f3a874aafa8018b79325', '김당근', '당근이', 'carrot@gmail.com', '010-1234-5555', 2, '49126', '부산 영도구 아랫서발길 9-11', '201호', '0:0:0:0:0:0:0:1', '2022-10-21 17:39:13'),
	('chwenotchew', 'c814573c7ceab9bd38ef526538d5c5066bcf8b7e0380f3a874aafa8018b79325', '최한솔', 'vernon', 'hs@gmail.com', '010-0217-0116', 2, '49126', '부산 영도구 아랫서발길 9-11', '102', '0:0:0:0:0:0:0:1', '2022-10-24 17:29:48');
...
-- 테이블 데이터 java2_bookstore.book:~9 rows (대략적) 내보내기
...
-- 테이블 데이터 java2_bookstore.customer:~5 rows (대략적) 내보내기
...
-- 테이블 데이터 java2_bookstore.order:~10 rows (대략적) 내보내기
...
-- 테이블 데이터 java2_college.lecture:~8 rows (대략적) 내보내기
INSERT INTO `lecture` (`lecNo`, `lecName`, `lecCredit`, `lecTime`, `lecClass`) VALUES
	...
	(300, '컴퓨터구조론', 3, 20, '본302'),
	(349, '사회복지 마케팅', 2, 50, '본301');

-- 테이블 java2_college.register 구조 내보내기
...
-- 테이블 데이터 java2_college.register:~8 rows (대략적) 내보내기
...
-- 테이블 java2_college.student 구조 내보내기
...
-- 테이블 데이터 java2_college.student:~6 rows (대략적) 내보내기
INSERT INTO `student` (`stdNo`, `stdName`, `stdHp`, `stdYear`, `stdAddress`) VALUES
	('20201016', '김유신', '010-1234-1001', 1, '김해시'),
...
-- 테이블 java2_hospital.departments 구조 내보내기
...
-- 테이블 java2_hospital.doctors 구조 내보내기
...
INSERT INTO `doctors` (`doc_id`, `doc_name`, `doc_birth`, `doc_gen`, `dep_no`, `doc_pos`, `doc_phone`, `doc_email`) VALUES
	...
	('D102104', '이사부', '1966-09-12', 'M', '102', '전문의', '010-2104-1966', 'leeesabu@bw.com'),
	...
	('D107104', '이황', '1989-12-09', 'M', '107', '전문의', '010-1704-7989', 'hwang@bw.com'),
	('D108101', '송상현', '1977-03-14', 'M', '108', '과장', '010-8101-1977', 'ssb@bw.com');

-- 테이블 java2_hospital.nurses 구조 내보내기
...
INSERT INTO `nurses` (`nur_id`, `nur_name`, `nur_birth`, `nur_gender`, `dep_no`, `nur_pos`, `nur_phone`, `nur_email`) VALUES
	('N101101', '송승헌', '1976-02-21', 'M', '101', '수간호사', '010-1101-7902', 'ssh@bw.com'),
...
-- 테이블 java2_hospital.patients 구조 내보내기
...
INSERT INTO `treatments` (`treat_no`, `doc_id`, `pat_id`, `treat_contents`, `treat_datetime`) VALUES
	(1021001, 'D102101', 'P102101', '감기, 몸살', '2022-09-08 19:04:51'),
	(1021003, 'D102104', 'P102102', '위염, 장염', '2022-09-08 19:04:51'),
	(1021009, 'D102104', 'P102103', '소화불량', '2022-09-08 19:04:51'),
	(1031002, 'D103101', 'P103101', '교통사고 외상', '2022-09-08 19:04:51'),
	(1031006, 'D103101', 'P103102', '목 디스크', '2022-09-08 19:04:51'),
	(1041004, 'D104101', 'P104101', '피부 트러블', '2022-09-08 19:04:51'),
	(1041007, 'D104101', 'P104102', '여드름', '2022-09-08 19:04:51'),
	(1041012, 'D104101', 'P104103', '팔목 화상', '2022-09-08 19:04:51'),
	(1051005, 'D105101', 'P105101', '코막힘 및 비염', '2022-09-08 19:04:51'),
	(1051011, 'D105101', 'P105102', '귀 이명', '2022-09-08 19:04:51'),
	(1071010, 'D107104', 'P107101', '가슴 통증', '2022-09-08 19:04:51'),
	(1081008, 'D108101', 'P108101', '오른쪽 발목 뼈 골절', '2022-09-08 19:04:51');
...
-- 테이블 java2_md_bookstore.publisher 구조 내보내기
...
-- 테이블 java2_md_company.member 구조 내보내기
...
-- 테이블 데이터 java2_shop.customer:~10 rows (대략적) 내보내기
INSERT INTO `customer` (`custId`, `name`, `hp`, `addr`, `rdate`) VALUES
	...
	('c103', '장보고', '010-1234-1003', '완도균 청산면', '2022-01-03'),
...
-- 테이블 데이터 java2_shop.order:~10 rows (대략적) 내보내기
...
-- 테이블 데이터 java2_shop.product:~7 rows (대략적) 내보내기
...
INSERT INTO `carts` (`cartNo`, `userId`, `prodNo`, `cartProdCount`, `cartProdDate`) VALUES
	(1, 'user1', 100101, 1, '2022-09-16 18:38:50'),
	(2, 'user1', 100110, 2, '2022-09-16 18:38:50'),
	(3, 'user3', 120103, 1, '2022-09-16 18:38:50'),
	(4, 'user4', 130112, 1, '2022-09-16 18:38:50'),
	(5, 'user5', 130101, 1, '2022-09-16 18:38:50'),
	(6, 'user2', 110101, 3, '2022-09-16 18:38:50'),
	(7, 'user2', 160103, 1, '2022-09-16 18:38:50'),
	(8, 'user2', 170115, 1, '2022-09-16 18:38:50'),
	(9, 'user3', 110101, 1, '2022-09-16 18:38:50'),
	(10, 'user6', 130101, 1, '2022-09-16 18:38:50');
...
INSERT INTO `orderitems` (`itemNo`, `orderNo`, `prodNo`, `itemPrice`, `itemDiscount`, `itemCount`) VALUES
	...
	(13, '22010710110', 120103, 210000, 10, 5);

-- 테이블 java2_shoppingmall.orders 구조 내보내기
...
INSERT INTO `orders` (`orderNo`, `userId`, `orderTotalPrice`, `orderAddr`, `orderStatus`, `orderDate`) VALUES
	('22010210001', 'user2', 52300, '서울시 마포구 121', 1, '2022-09-16 18:06:35'),
	('22010210002', 'user3', 56700, '서울시 강남구 21-1', 1, '2022-09-16 18:06:35'),
	('22010210010', 'user4', 72200, '서울시 강서구 큰대로 38', 2, '2022-09-16 18:06:35'),
	('22010310001', 'user5', 127000, '경기도 광주시 초월로 21', 1, '2022-09-16 18:06:35'),
	('22010310100', 'user1', 120000, '경기도 수원시 120번지', 0, '2022-09-16 18:06:35'),
	('22010410101', 'user6', 792000, '부산시 남구 21-1', 2, '2022-09-16 18:06:35'),
	('22010510021', 'user7', 92200, '부산시 부산진구 56 10층', 4, '2022-09-16 18:06:35'),
	('22010510027', 'user8', 112000, '대구시 팔달로 19', 3, '2022-09-16 18:06:35'),
	('22010510031', 'user10', 792000, '대전시 한밭로 24-1', 2, '2022-09-16 18:06:35'),
	('22010710110', 'user9', 94500, '광주시 충열로 11', 1, '2022-09-16 18:06:35');
...
INSERT INTO `points` (`pointNo`, `userId`, `point`, `pointDesc`, `pointDate`) VALUES
	(1, 'user1', 1000, '회원가입 1000 적립', '2022-09-16 18:00:20'),
	(2, 'user1', 6000, '상품구매 5% 적립', '2022-09-16 18:00:20'),
	(3, 'user3', 2835, '상품구매 5% 적립', '2022-09-16 18:00:20'),
	(4, 'user7', 3610, '상품구매 5% 적립', '2022-09-16 18:00:20'),
	(5, 'user5', 3000, '이벤트 응모 3000 적립', '2022-09-16 18:00:20'),
	(6, 'user2', 1000, '회원가입 1000 적립', '2022-09-16 18:00:20'),
	(7, 'user2', 2000, '이벤트 응모 2000 적립', '2022-09-16 18:00:20'),
	(8, 'user2', 2615, '상품구매 5% 적립', '2022-09-16 18:00:20'),
	(9, 'user3', 1500, '이벤트 응모 1500 적립', '2022-09-16 18:00:20'),
	(10, 'user6', 15840, '상품구매 2% 적립', '2022-09-16 18:00:20');
...
INSERT INTO `products` (`prodNo`, `cateNo`, `prodName`, `prodPrice`, `prodStock`, `prodSold`, `prodDiscount`, `sellerNo`) VALUES
	(100101, 11, '반팔티 L~2XL', 25000, 869, 132, 20, 10003),
	(100110, 10, '트레이닝 통바지', 38000, 1602, 398, 15, 10004),
	(110101, 10, '신상 여성운동화', 76000, 160, 40, 5, 10003),
	(120101, 12, '암소 1등급 구이셋트 1.2kg', 150000, 0, 87, 15, 10010),
	(120103, 12, '바로구이 부채살 250g', 21000, 0, 61, 10, 10010),
	(130101, 13, '[ANF] 식스프리 강아지 사료', 56000, 58, 142, 0, 10006),
	(130112, 13, '중대형 사계절 강아지옷', 15000, 120, 80, 0, 10006),
	(141001, 14, '라떼 2인 소파/방수 패브릭', 320000, 0, 42, 0, 10001),
	(160103, 16, '치닝디핑 33BR 철봉', 120000, 32, 28, 0, 10009),
	(170115, 17, '지포스 3080 그래픽카드', 900000, 28, 12, 12, 10007);
...
-- 테이블 java2_shoppingmall.users 구조 내보내기
...
INSERT INTO `users` (`userId`, `userName`, `userBirth`, `userGender`, `userHp`, `userEmail`, `userPoint`, `userLevel`, `userAddr`, `userRegDate`) VALUES
	('user1', '김유신', '1976-01-21', 'M', '010-1101-1976', 'kimys@naver.com', 0, 1, '서울', '2022-09-16 17:55:55'),
	('user10', '허난설편', '1992-09-07', 'F', '010-7103-1992', NULL, 4100, 3, '광주', '2022-09-16 17:55:55'),
	('user2', '계백', '1795-06-11', 'M', '010-1102-1975', NULL, 1000, 1, '서울', '2022-09-16 17:55:55'),
	('user3', '김춘추', '1989-05-30', 'M', '010-1103-7989', NULL, 1200, 2, '서울', '2022-09-16 17:55:55'),
	('user4', '이사부', '1979-04-13', 'M', '010-2101-1979', 'leesabu@gmail.com', 2600, 1, '서울', '2022-09-16 17:55:55'),
	('user5', '장보고', '1966-09-12', 'M', '010-2104-1966', 'jangbg@naver.com', 9400, 4, '대전', '2022-09-16 17:55:55'),
	('user6', '선덕여왕', '1979-07-28', 'M', '010-3101-1979', 'gueen@naver.com', 1600, 2, '대전', '2022-09-16 17:55:55'),
	('user7', '강감찬', '1984-06-15', 'F', '010-4101-1984', 'kang@daum.net', 800, 0, '대구', '2022-09-16 17:55:55'),
	('user8', '신사임당', '1965-10-21', 'M', '010-5101-1965', 'sinsa@gmail.com', 1500, 1, '대구', '2022-09-16 17:55:55'),
	('user9', '이이', '1972-11-28', 'F', '010-6101-1972', 'leelee@nate.com', 3400, 3, '부산', '2022-09-16 17:55:55');
...
-- 테이블 java2_university.lectures 구조 내보내기
...
-- 테이블 java2_university.professors 구조 내보내기
...
INSERT INTO `professors` (`proNo`, `proName`, `proJumin`, `proHp`, `proEmail`, `proAddr`, `depNo`) VALUES
	...
	('P11103', '김춘추', '780412-1234567', '010-2101-1979', 'kimcc@hg.ac.kr', '대전', 11),
	...
	('P23102', '선덕여왕', '830614-1234567', '010-4101-1984', 'queen@hg.ac.kr', '대구', 23),
	('P31101', '강감찬', '641020-1234567', '010-5101-1965', 'kang@hg.ac.kr', '대구', 31),
	('P31104', '신사임당', '711127-1234567', '010-6101-1972', 'sisa@hg.ac.kr', '부산', 31),
	('P40101', '이이', '910906-1234567', '010-7103-1992', 'leelee@hg.ac.kr', '부산', 40),
	('P40102', '이황', '881208-1234567', '010-7104-1989', 'hwang@hg.ac.kr', '광주', 40),
	('P42103', '송상현', '760313-1324567', '010-8101-1977', 'ssh@hg.ac.kr', '광주', 42);

-- 테이블 java2_university.register 구조 내보내기
CREATE TABLE IF NOT EXISTS `register` (
  `stdNo` char(8) NOT NULL,
  `lecNo` char(6) NOT NULL,
  `proNo` char(6) NOT NULL,
...
-- 테이블 java2_university.students 구조 내보내기
CREATE TABLE IF NOT EXISTS `students` (
  ...
  KEY `fk_Students_Departments_idx` (`depNo`),
...
INSERT INTO `students` (`stdNo`, `stdName`, `stdJumin`, `stdHP`, `stdEmail`, `stdAddr`, `proNo`, `depNo`) VALUES
	...
	('20111011', '전지현', '890530-1234567', '010-1103-8905', 'jjh@naver.com', '대전', 'P11103', 11),
	...
	('21231002', '고소영', '840615-1234567', '010-4101-8406', 'goso@daum.net', '대구', 'P23102', 23),
	('22311011', '김연아', '651021-1234567', '010-5101-6510', 'yana@daum.net', '대구', 'P31104', 31),
...
-- 테이블 데이터 java2db.child:~1 rows (대략적) 내보내기
...
-- 테이블 데이터 java2db.department:~7 rows (대략적) 내보내기
...
-- 테이블 데이터 java2db.member:~11 rows (대략적) 내보내기
INSERT INTO `member` (`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES
	('a101', '박혁거세', '010-1234-1001', '부장', 101, '2022-08-25 18:10:49'),
	('a102', '김유신', '010-1234-1002', '차장', 101, '2022-08-25 18:10:50'),
	('a103', '김춘추', '010-1234-1003', '사원', 101, '2022-08-25 18:10:51'),
	('a104', '장보고', '010-1234-1004', '대리', 102, '2022-08-25 18:10:51'),
	('a105', '강감찬', '010-1234-1005', '과장', 102, '2022-08-25 18:10:52'),
	('a106', '이성계', '010-1234-1006', '차장', 103, '2022-08-25 18:10:52'),
	('a107', '정철', '010-1234-1007', '차장', 103, '2022-08-25 18:10:53'),
	('a108', '이순신', '010-1234-1008', '부장', 104, '2022-08-25 18:10:54'),
	('a109', '허균', '010-1234-1009', '부장', 104, '2022-08-25 18:10:54'),
	('a110', '정약용', '010-1234-1010', '사원', 105, '2022-08-25 18:10:55'),
	('a111', '박지원', '010-1234-1011', '사원', 105, '2022-08-25 18:10:57');

-- 테이블 java2db.parent 구조 내보내기
...
-- 테이블 데이터 java2db.parent:~1 rows (대략적) 내보내기
...
-- 테이블 데이터 java2db.sales:~30 rows (대략적) 내보내기
...
-- 테이블 데이터 java2db.sales2:~30 rows (대략적) 내보내기
...
-- 테이블 데이터 java2db.tblproduct:~6 rows (대략적) 내보내기
INSERT INTO `tblproduct` (`prdCode`, `prdName`, `prdPrice`, `prdAmount`, `prdCompany`, `prdMakeDate`) VALUES
	...
	(4, '세탁기', 1600, 8, 'LG', '2022-01-06'),
	(5, '컴퓨터', 1100, 0, '삼성', '2021-01-01'),
	(6, '휴대폰', 900, 102, '삼성', '2022-01-16');

-- 테이블 java2db.tbluser 구조 내보내기
...
-- 테이블 데이터 java2db.tbluser:~4 rows (대략적) 내보내기
...
-- 테이블 데이터 java2db.user2:~5 rows (대략적) 내보내기
...
-- 테이블 데이터 java2db.user3:~4 rows (대략적) 내보내기
INSERT INTO `user3` (`uid`, `name`, `hp`, `age`) VALUES
	('a101', '김유신', '010-1234-1001', 25),
	('a102', '김춘추', '010-1234-1002', 23),
	('a103', '장보고', '010-1234-1003', 33),
	('a104', '강감찬', '010-1234-1004', 44);
...
-- 테이블 데이터 java2db.user4:~2 rows (대략적) 내보내기
INSERT INTO `user4` (`seq`, `name`, `gender`, `age`, `addr`) VALUES
	(2, '신사임당', 2, 27, '강릉시'),
	(4, '김유신', 1, 25, '김해시');

-- 테이블 java2db.user5 구조 내보내기
...
-- 테이블 데이터 java2db.user5:~2 rows (대략적) 내보내기
INSERT INTO `user5` (`uid`, `name`, `birth`, `gender`, `age`, `addr`, `hp`) VALUES
	('a101', '김유신', '2022-09-27', 1, 25, '김해시', '010-1234-1003'),
	('a102', '김춘추', '2022-10-27', 1, NULL, '부산', '010-1234-2222');

-- 테이블 java2db.user6 구조 내보내기
...
-- 테이블 데이터 java2db.user6:~1 rows (대략적) 내보내기
INSERT INTO `user6` (`uid`, `name`, `birth`, `gender`, `age`, `addr`, `hp`) VALUES
	('a101', '김유신', '0000-00-00', 1, 25, '김해시', NULL);
